...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        // Try converting each i16 to u8. If any fail, map the error to your custom variant.
        let red = r.try_into().map_err(|_| Self::Error::IntConversion)?;
        let green = g.try_into().map_err(|_| Self::Error::IntConversion)?;
        let blue = b.try_into().map_err(|_| Self::Error::IntConversion)?;
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        ...
        let red = arr[0].try_into().map_err(|_| Self::Error::IntConversion)?;
        let green = arr[1].try_into().map_err(|_| Self::Error::IntConversion)?;
        let blue = arr[2].try_into().map_err(|_| Self::Error::IntConversion)?;
